...
#### 2.
Abre Nautilus y selecciona `Batch DTA Processor`.   
...
#### 4.
Cuando regreses a la pantalla principal de Nautilus. selecciona `PS3 Converter`.  
...
#### 6.
Se actualizara cualquier archivo que requiere encripción o su calidad diferente.  
...
Then click on `Add Rock Band Song` or drag and drop to add the CON files from before.  
